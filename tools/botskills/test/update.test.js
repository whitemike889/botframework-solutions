...
Error: The Skill doesn't exist in the Assistant, run 'botskills connect --botName ${configuration.botName} --localManifest "${configuration.localManifest}" --luisFolder "${configuration.luisFolder}" --${configuration.lgLanguage}'`);
        });
